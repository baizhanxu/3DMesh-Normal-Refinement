...
def main():
    ...
    parser.add_argument("--style_ref", type=str, default=None, help="Optional path to a style reference image for Autoregressive mode.")
    ...
    for case_dir in root_path.iterdir():
        ...
        if args.autoregressive:
            ...
            if not has_gemini or re_gen:
                ...
                cat_name = case_dir.name.split('_')[0] 
                gemini_process(str(merged_normals_path), cat=cat_name, num_views=num_views)
            else:
