...
class MeshOptimizer:
    ...
    def remesh(self, flip:bool=True, custom_edge_lens:torch.Tensor=None)->tuple[torch.Tensor,torch.Tensor]:
        if custom_edge_lens is not None:
            # Update internal ref len with custom constraint
            # Ensure it respects the global limits
